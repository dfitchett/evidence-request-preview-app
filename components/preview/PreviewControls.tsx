    ...
    <div className="vads-u-margin-bottom--3 border border-1px border-color-gray-medium">
      ...
      <va-accordion bordered open-single>
        ...
        <va-accordion-item header="Preview Settings">
          <div className="vads-u-display--flex vads-u-flex-wrap--wrap vads-u-align-items--center">
            {/* View Mode Toggle */}
            <div
              className="vads-u-flex--1 vads-u-margin--1"
              ...
              <select
                ...
                onChange={(e) =>
                  handleViewModeChange(
                    e.target.value as PreviewSettings["viewMode"],
                  )
                }
